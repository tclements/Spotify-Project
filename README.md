...
Based on this figure, the Key variables seem to be largely unimportant -- four of twelve of them fall into the bottom thirty predictors. Aside from the Key variables, we see an assortment of interaction terms mainly involving loudness and instrumentalness.
